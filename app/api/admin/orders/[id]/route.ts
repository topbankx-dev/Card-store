...
const VALID_TRANSITIONS: Record<string, string[]> = {
  PENDING: ['PAID', 'PROCESSING', 'READY_FOR_PICKUP', 'SHIPPED', 'CANCELLED'],
  PAID: ['PROCESSING', 'READY_FOR_PICKUP', 'SHIPPED', 'DELIVERED', 'REFUNDED', 'CANCELLED'],
  PROCESSING: ['READY_FOR_PICKUP', 'SHIPPED', 'DELIVERED', 'REFUNDED', 'CANCELLED'],
  READY_FOR_PICKUP: ['DELIVERED', 'REFUNDED', 'CANCELLED'],
